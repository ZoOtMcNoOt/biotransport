...
void register_utilities_bindings(py::module_& m) {
    ...
    // =========================================================================
    auto dimensionless_mod = m.def_submodule(
        "dimensionless",
        "Dimensionless number utilities for biotransport analysis (Re, Sc, Pe, Bi, Fo, Sh).");

    dimensionless_mod.def("reynolds", &dimensionless::reynolds, py::arg("density"),
                          py::arg("velocity"), py::arg("length"), py::arg("viscosity"),
    ...
    dimensionless_mod.def("schmidt", &dimensionless::schmidt, py::arg("viscosity"),
                          py::arg("density"), py::arg("diffusivity"),
    ...
    dimensionless_mod.def("peclet", &dimensionless::peclet, py::arg("velocity"), py::arg("length"),
                          py::arg("diffusivity"),
                          "Peclet number: Pe = vL/D (convective/diffusive transport).");

    dimensionless_mod.def("biot", &dimensionless::biot, py::arg("h_m"), py::arg("length"),
                          py::arg("diffusivity"),
                          "Biot number (mass): Bi = h_m·L/D (external/internal resistance).");

    dimensionless_mod.def("fourier", &dimensionless::fourier, py::arg("diffusivity"),
                          py::arg("time"), py::arg("length"),
                          "Fourier number: Fo = Dt/L² (dimensionless time for diffusion).");

    dimensionless_mod.def("sherwood", &dimensionless::sherwood, py::arg("h_m"), py::arg("length"),
                          py::arg("diffusivity"),
    ...
    dimensionless_mod.def("is_lumped_valid", &dimensionless::is_lumped_valid, py::arg("bi"),
    ...
    // =========================================================================
    auto analytical_mod = m.def_submodule(
        "analytical",
    ...
    analytical_mod.def("diffusion_1d_semi_infinite", &analytical::diffusion_1d_semi_infinite,
                       py::arg("x"), py::arg("t"), py::arg("diffusivity"), py::arg("C_surface"),
                       py::arg("C_initial"),
    ...
    analytical_mod.def("diffusion_penetration_depth", &analytical::diffusion_penetration_depth,
                       ...
                       "Legacy name for the characteristic diffusion length sqrt(D*t); no "
                       "concentration threshold is implied.");

    analytical_mod.def("diffusion_length", &analytical::diffusion_length, py::arg("diffusivity"),
                       py::arg("t"), "Characteristic diffusion length sqrt(D*t).");

    analytical_mod.def("lumped_exponential", &analytical::lumped_exponential, py::arg("C_0"),
                       py::arg("C_inf"), py::arg("t"), py::arg("tau"),
                       "Lumped parameter exponential: C(t) = C_∞ + (C_0 - C_∞)exp(-t/τ).");

    // Pipe flow
    analytical_mod.def("poiseuille_velocity", &analytical::poiseuille_velocity, py::arg("r"),
    ...
    analytical_mod.def("poiseuille_flow_rate", &analytical::poiseuille_flow_rate, py::arg("radius"),
                       py::arg("dp_dz"), py::arg("viscosity"),
    ...
    analytical_mod.def("plane_poiseuille_velocity", &analytical::plane_poiseuille_velocity,
                       py::arg("y"), py::arg("half_height"), py::arg("dp_dx"), py::arg("viscosity"),
                       "Pressure-driven plane-Poiseuille velocity between stationary plates.");

    analytical_mod.def("plane_poiseuille_max_velocity", &analytical::plane_poiseuille_max_velocity,
                       py::arg("half_height"), py::arg("dp_dx"), py::arg("viscosity"),
                       "Centerline velocity in pressure-driven plane-Poiseuille flow.");

    analytical_mod.def("couette_velocity", &analytical::couette_velocity, py::arg("y"),
                       py::arg("gap_height"), py::arg("moving_wall_velocity"),
                       "Couette profile u(y)=U*y/H between a fixed and a translating plate.");

    analytical_mod.def("couette_max_velocity", &analytical::couette_max_velocity,
                       py::arg("moving_wall_velocity"),
                       "Maximum Couette speed at the moving wall.");

    // Bernoulli
    analytical_mod.def("bernoulli_velocity", &analytical::bernoulli_velocity, py::arg("v1"),
                       py::arg("p1"), py::arg("z1"), py::arg("p2"), py::arg("z2"),
                       py::arg("density"), py::arg("g") = 9.81,
                       "Solve Bernoulli equation for v2 given conditions at points 1 and 2.");

    // Kinetics
    analytical_mod.def("first_order_decay", &analytical::first_order_decay, py::arg("C_0"),
                       py::arg("k"), py::arg("t"), "First-order decay: C(t) = C_0·exp(-kt).");

    analytical_mod.def("logistic_growth", &analytical::logistic_growth, py::arg("C_0"),
                       py::arg("carrying_capacity"), py::arg("growth_rate"), py::arg("t"),
                       "Logistic growth: C(t) = K / (1 + ((K-C_0)/C_0)·exp(-rt)).");

    // Taylor-Couette flow (rotating cylinders) — NASA Bioreactor
    analytical_mod.def(
        "taylor_couette_velocity", &analytical::taylor_couette_velocity, py::arg("r"), py::arg("a"),
        py::arg("b"), py::arg("omega_a"), py::arg("omega_b"),
    ...
    analytical_mod.def("taylor_couette_torque", &analytical::taylor_couette_torque, py::arg("a"),
                       py::arg("b"), py::arg("omega_a"), py::arg("omega_b"), py::arg("viscosity"),
                       "Torque per unit length on inner cylinder in Taylor-Couette flow.");

    // Viscoelastic models — HW6 Problem 5
    analytical_mod.def("maxwell_relaxation", &analytical::maxwell_relaxation, py::arg("E"),
                       py::arg("eta"), py::arg("epsilon_0"), py::arg("t"),
    ...
    analytical_mod.def("maxwell_relaxation_time", &analytical::maxwell_relaxation_time,
                       py::arg("E"), py::arg("eta"), "Maxwell relaxation time τ = η/E.");

    analytical_mod.def("kelvin_voigt_creep", &analytical::kelvin_voigt_creep, py::arg("E"),
                       py::arg("eta"), py::arg("sigma_0"), py::arg("t"),
                       "Kelvin-Voigt creep: ε(t) = (σ₀/E)·(1 - exp(-t/τ)) where τ = η/E.");

    analytical_mod.def("sls_relaxation", &analytical::sls_relaxation, py::arg("E1"), py::arg("E2"),
                       py::arg("eta"), py::arg("epsilon_0"), py::arg("t"),
                       "Standard Linear Solid stress relaxation: σ(t) = ε₀·(E₁ + E₂·exp(-t/τ)).");

    analytical_mod.def("sls_creep", &analytical::sls_creep, py::arg("E1"), py::arg("E2"),
                       py::arg("eta"), py::arg("sigma_0"), py::arg("t"),
                       "Standard Linear Solid creep response.");

    analytical_mod.def("burgers_creep", &analytical::burgers_creep, py::arg("E1"), py::arg("mu1"),
                       py::arg("E2"), py::arg("mu2"), py::arg("sigma_0"), py::arg("t"),
                       "Burgers 4-parameter model creep: ε(t) = σ₀·J(t).");

    analytical_mod.def("burgers_compliance", &analytical::burgers_compliance, py::arg("E1"),
                       py::arg("mu1"), py::arg("E2"), py::arg("mu2"), py::arg("t"),
    ...
    analytical_mod.def("phase_angle", &analytical::phase_angle, py::arg("G1"), py::arg("G2"),
